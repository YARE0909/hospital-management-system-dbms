...
export const RegisterAppointmentSchema = z.object({
    ...
    status: z.enum(["pending", "completed", "cancelled", "noShow"], { required_error: "Status is required", invalid_type_error: "Status must be one of 'pending', 'completed', 'cancelled', 'noShow'" }),
