...
export const RegisterDoctorSchema = z.object({
    ...
    departmentId: z.string({ required_error: "Department ID is required", invalid_type_error: "Department ID must be a string" }),
    specialization: z.enum(["Heart Surgeon", "Dentist", "Orthopedic Surgeon"], { required_error: "Specialization is required", invalid_type_error: "Specialization must be either Heart Surgeon, Dentist, or Orthopedic Surgeon" }),
}).strict();