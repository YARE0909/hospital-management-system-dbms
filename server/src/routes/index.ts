...
import { RegisterAppointmentRouter, GetAppointmentListRouter, GetAppointmentDetailsInfoRouter } from "./appointments/index.js";
...
export default () => {
    ...
    app.use("/appointmentDetails/info", GetAppointmentDetailsInfoRouter)
